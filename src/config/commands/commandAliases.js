 ...
 * Arabic names are message-command shortcuts for the canonical English commands.
 */
export const commandAliases = {
  bal: 'balance', money: 'balance', cash: 'balance',
  dep: 'deposit', with: 'withdraw',
  bet: 'gamble', give: 'pay', send: 'pay',
  h: 'help', info: 'help',

  // Moderation shortcuts
  بان: 'ban', انبان: 'unban',
  تايم: 'timeout', انتايم: 'untimeout',
  mute: 'timeout', unmute: 'untimeout',
  وارن: 'warn', وارنات: 'warnings',
  كلير: 'purge', clear: 'purge',
  kick: 'kick', ban: 'ban', warn: 'warn',
  purge: 'purge', untimeout: 'untimeout',

  rank: 'rank', lvl: 'rank', xp: 'rank',
  ...
  gstart: 'gcreate', gstop: 'gend', groll: 'greroll',
  ...
  calc: 'calculate', math: 'calculate', weather: 'weather', todo: 'todo', report: 'report',
  userinfo: 'userinfo', whois: 'userinfo', ui: 'userinfo',
...
export const subcommandAliases = {
  ...
  start: 'create', stop: 'end', roll: 'reroll', add: 'add', remove: 'remove', list: 'list',
};
