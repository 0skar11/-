...
//   • Only store commands can be written there (`متجر`، `متجر 1`، `مخزني`، `اسعار`، `شراء عربية`، `رصيد`، `توب cc`، `رولي`، `/store`...);
...
export const STORE_COMMAND_NAMES = new Set(['store', 'bourse', 'cc', 'cctop', 'myrole']);
